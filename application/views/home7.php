                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        <div class="hero-style7 text-center">
                            <h1 class="hero-title wow img-custom-anim-top animated text-smoke">We Help to Grow Your Business</h1>
                            <p class="hero-text wow img-custom-anim-top animated text-smoke">We are digital agency that helps businesses develop immersive and engaging user experiences that drive top level growth</p>
                        </div>
                    </div>
                    <div class="col-lg-8">
                        <div class="hero-7-thumb wow img-custom-anim-top animated" data-wow-duration="1.5s" data-wow-delay="0.2s">
                            <img src="assets/img/hero/hero-7-1.jpg" alt="img">
                        </div>
                    </div>
                </div>
            </div>
