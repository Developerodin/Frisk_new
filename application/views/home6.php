   <!--==============================
    ...
    <div class="hero-wrapper hero-6" id="hero">
        <div class="container">
            <div class="hero-style6">
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        <h1 class="hero-title text-lg-end wow img-custom-anim-right animated" data-wow-duration="1.5s" data-wow-delay="0.1s">Creating The</h1>

                        <h1 class="hero-title wow img-custom-anim-left animated" data-wow-duration="1.7s" data-wow-delay="0.1s">Best Digital</h1>

                        <h1 class="hero-title text-lg-end wow img-custom-anim-right animated" data-wow-duration="1.5s" data-wow-delay="0.1s">Solution</h1>
                    </div>
        ...
        <div class="hero-6-thumb wow img-custom-anim-top animated jarallax" data-bg-src="assets/img/hero/hero-6-1.webp">
        </div>
    </div>
    <!--======== / Hero Section ========-->
                ...
                <div class="col-12">
                    <div class="portfolio-static-wrap">
                        <div class="portfolio-static">
                            <div class="portfolio-wrap style5">
                                <div class="portfolio-thumb">
                                    <img src="assets/img/portfolio/portfolio5_1.jpg" alt="portfolio">
                                </div>
                        ...
                        <div class="portfolio-static">
                            <div class="portfolio-wrap style5">
                                <div class="portfolio-thumb">
                                    <img src="assets/img/portfolio/portfolio5_2.jpg" alt="portfolio">
                                </div>
                                <div class="portfolio-details">
                                    <div class="media-left">
                                        <ul class="portfolio-meta">
                        ...
                        <div class="portfolio-static">
                            <div class="portfolio-wrap style5">
                                <div class="portfolio-thumb">
                                    <img src="assets/img/portfolio/portfolio5_3.jpg" alt="portfolio">
                                </div>
                                <div class="portfolio-details">
                                    <div class="media-left">
                                        <ul class="portfolio-meta">
                        ...
                        <div class="portfolio-static">
                            <div class="portfolio-wrap style5">
                                <div class="portfolio-thumb">
                                    <img src="assets/img/portfolio/portfolio5_4.jpg" alt="portfolio">
                                </div>
                                <div class="portfolio-details">
                                    <div class="media-left">
                                        <ul class="portfolio-meta">
