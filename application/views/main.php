    ...
    <div class="hero-wrapper hero-1" id="hero">
      <div class="container">
          <div class="hero-style1">
              <div class="row">
                  <div class="col-lg-12">
                      <h1 class="hero-title wow img-custom-anim-left animated" data-wow-duration="1.5s" data-wow-delay="0.1s">Building Timeless Brands</h1>
                  ...
                  <div class="overflow-hidden">
                      <div class="about-content-wrap ">
                          <div class="title-area mb-0">
                              ...
                              <p class="sec-text mt-35">we have what it takes to help ANY brand go from unknown to stardom. How do you appear when your customers search for your brand name online?</p>
                              <p class="sec-text mt-30">We got this. Our PR Agency guarantees to make you look great online when your customers search for your brand name on Google or any other search engine for that matter. We help you build trust and credibility.</p>
...
<div class="row gy-4 justify-content-center">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="pricing-card bg-smoke">
                        ...
                        <div class="checklist">
                            <ul>
                                <li><i class="fas fa-check"></i> 3 Publiuction/Term</li>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="pricing-card bg-smoke">
                        ...
                        <div class="checklist">
                            <ul>
                                <li><i class="fas fa-check"></i> 1 Publication/mo</li>
