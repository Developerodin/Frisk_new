   <!--==============================
    Hero Area
    ==============================-->
    <div class="hero-wrapper hero-8" id="hero" data-bg-src="assets/img/hero/hero-8-1.png">
        <div class="container">
            <div class="hero-style8">
                <div class="row">
                    <div class="col-lg-8">
                        <h2 class="hero-subtitle wow img-custom-anim-left animated text-smoke">Hi, I’m Daniel Pickman</h2>
                        <h1 class="hero-title wow img-custom-anim-left animated text-smoke">Senior Graphics Designer</h1>
                    </div>
            ...
            <div class="row justify-content-xl-between justify-content-center">
                <div class="col-xl-5 col-lg-10">
                    <div class="title-area mb-xl-0 mb-40">
                        ...
                        <p class="copyright-text mt-4 mb-3">Copyright © 2024
