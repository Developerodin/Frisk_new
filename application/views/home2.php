...
<div class="hero-wrapper hero-2" id="hero">
    ...
    <div class="container">
        <div class="hero-style2">
            <div class="row">
                <div class="col-lg-9">
                    <h1 class="hero-title wow img-custom-anim-right animated text-white">We Make</h1>
                    <h1 class="hero-title wow img-custom-anim-left animated text-white">Creative Things</h1>
                </div>
                <div class="col-lg-10 offset-lg-2">
                    <h1 class="hero-title wow img-custom-anim-right animated text-white">Everyday</h1>
                </div>
            ...
            <div class="row justify-content-end">
                <div class="col-xxl-6 col-xl-7 col-lg-9">
                    <div class="wow img-custom-anim-right animated">
...
<div class="container-fluid p-0 overflow-hidden">
    <div class="slider__marquee clearfix marquee-wrap">
        <div class="marquee_mode marquee__group">
            <div  class="js-marquee-wrapper motion">
                <div class="js-marquee-wrapper" style="margin-right: 0px; float: left;">
...
<div class="service-area-1 space bg-theme">
    <div class="service-img-1-1 shape-mockup wow img-custom-anim-left animated" data-wow-duration="1.5s"
            ...
            <div class="col-lg-6">
                <div class="about-content-wrap">
                    <div class="title-area mb-0">
                        ...
                        <p class="sec-text mt-35 mb-40">We are a creative agency working with brands building insightful
